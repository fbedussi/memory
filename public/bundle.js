    ...
    switch (action.type) {
        ...
        case 'CARD_CLICKED':
            ...
            if (flippedCards.length === 2) {
                cardsMatch = flippedCards.reduce(function (a, b) {
